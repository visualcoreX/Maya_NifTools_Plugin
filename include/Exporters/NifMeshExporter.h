#ifndef _NIFMESHEXPORTER_H
#define _NIFMESHEXPORTER_H
...
typedef Ref<NifMeshExporter> NifMeshExporterRef;

class NifMeshExporter : public NifTranslatorFixtureItem {
...
public:
	...
	virtual void ApplyAllSkinOffsets( NiAVObjectRef & root );
