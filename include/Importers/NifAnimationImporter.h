#ifndef _NIFANIMATIONIMPORTER_H
#define _NIFANIMATIONIMPORTER_H
...
typedef Ref<NifAnimationImporter> NifAnimationImporterRef;

class NifAnimationImporter : public NifTranslatorFixtureItem {
public:
