#ifndef _NIFFIXTUREITEM_H
#define _NIFFIXTUREITEM_H
...
class NifTranslatorFixtureItem;
...
public:
	...
	NifTranslatorFixtureItem();
	NifTranslatorFixtureItem(NifTranslatorOptionsRef translatorOptions, NifTranslatorDataRef translatorData, NifTranslatorUtilsRef translatorUtils);

	virtual ~NifTranslatorFixtureItem();
