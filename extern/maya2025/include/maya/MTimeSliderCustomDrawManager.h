...
public:
    ...
    \param[in] time Time of the initial edit frame. This is the frame on
    the time slider where the mouse was pressed to begin editing.
    */
...
public:
    ...
    \param[in] offset Time difference between this call and the last.
    \param[in] snap Indicates that the edit operation should snap to whole frames.
    \param[in] currentTime Time at the current frame.
    \param[in] editType The type of edit operation being performed.
    */
    virtual void operator()(MTime offset, bool snap, MTime currentTime, 
...
public:
    ...
    \param[in] copy Sets whether the current edit is a copy operation or not.
    */
...
public:
    ...
    /*!
    Called on mouse release after a primitive has been edited.
    */
