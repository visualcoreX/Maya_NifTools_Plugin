...
public:
	...
	bool		isEnforcingUniqueName( MStatus* ReturnStatus=NULL ) const;
	...
	OPENMAYA_AVAILABLE(2025)
	MStatus		setEnforcingUniqueName( bool state);
	...
	OPENMAYA_AVAILABLE(2025)
	MString     pathName( bool useLongName=true, bool useCompression=true, MStatus* ReturnStatus=NULL ) const;
