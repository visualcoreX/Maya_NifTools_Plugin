...
#if __has_include(<Python/eval.h>)
// Python 3.11 moved the header content in ceval.h
// ceval.h is included from Python.h
// This can be removed once Python 3.10 support is dropped.
